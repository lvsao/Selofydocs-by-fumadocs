...
### ✨ New Features
- Added GitHub Actions workflow for automatic changelog synchronization
- Releases now automatically update documentation site

### 📝 Documentation
- Added comprehensive changelog automation guide
- Workflow triggers on release publish events
...
|---------|--------------|------------|
| v1.2.1   | 2025-10-10  | ## ✨ New Features |
